...
<ns:view path="/WEB-INF/jsp/settlement/save.jsp"/>
...
<h2><bean:message key="settlement.saved.heading"/></h2>
<table class="details" cellpadding="3" cellspacing="0" border="1">
<tr>
<th><bean:message key="settlement.amount"/></th><td><ns:field name="settlementAmount" value="${settlementAmount}" type="money"/></td></tr>
<tr>
<th><bean:message key="settlement.savedBy"/></th><td><ns:field
name="savedBy" value="${sessionScope.user}" type="text"/></td></tr>
</table>
<p><bean:message key="settlement.saved.message"/></p>
