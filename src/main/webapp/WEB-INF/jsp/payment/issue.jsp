...
<ns:view path="/WEB-INF/jsp/payment/issue.jsp"/>
...
<h2><bean:message key="payment.issue.heading"/></h2>
<table class="details" cellpadding="3" cellspacing="0" border="1">
<tr>
<th><bean:message key="payment.amount"/></th><td><ns:field name="paymentAmount" value="${paymentAmount}" type="money"/></td></tr>
<tr>
<th><bean:message key="payment.check"/></th><td><ns:field name="checkNumber" value="${checkNumber}" type="text"/></td></tr>
<tr>
<th><bean:message key="payment.status"/></th><td><ns:field name="paymentStatus" value="${paymentStatus}" type="text"/></td></tr>
</table>
<p><bean:message key="payment.issue.message"/></p>
