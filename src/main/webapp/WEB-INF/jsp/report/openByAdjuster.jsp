...
<ns:view path="/WEB-INF/jsp/report/openByAdjuster.jsp"/>
...
<h2><bean:message key="report.open.heading"/></h2>
<table class="results" cellpadding="3" cellspacing="0" border="1">
<tr>
<th><bean:message key="report.adjuster"/></th>
<th><bean:message key="report.openCount"/></th>
<th><bean:message key="report.reserveTotal"/></th></tr>
<logic:iterate id="row" name="reportRows">
<tr><td><bean:write name="row" property="adjuster"/></td>
<td>
<ns:field name="openCount_${row.adjuster}" value="${row.openCount}"
type="integer"/></td>
<td><ns:field
name="reserveTotal_${row.adjuster}" value="${row.reserveTotal}" type="money"/></td></tr>
</logic:iterate>
</table>
<p><bean:message key="report.open.note"/></p>
