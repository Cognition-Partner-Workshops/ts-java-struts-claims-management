...
<ns:view path="/WEB-INF/jsp/admin/adjusters.jsp"/>
...
<h2><bean:message key="admin.adjusters.heading"/></h2>
<table class="results" cellpadding="3" cellspacing="0" border="1">
<tr>
<th><bean:message key="admin.username"/></th>
<th><bean:message key="admin.name"/></th>
<th><bean:message key="admin.region"/></th></tr>
<tr><td><ns:field name="adjusterUsername_1" value="adjuster1" type="text"/></td>
<td><bean:message key="admin.sampleName"/></td>
<td><bean:message
key="admin.sampleRegion"/></td></tr>
</table>
<p><a href="editAdjuster.do"><bean:message key="admin.editLink"/></a></p>
