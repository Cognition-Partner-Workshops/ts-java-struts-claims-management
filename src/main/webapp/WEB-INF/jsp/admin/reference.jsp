...
<ns:view path="/WEB-INF/jsp/admin/reference.jsp"/>
...
<h2><bean:message key="admin.reference.heading"/></h2>
<table class="results" cellpadding="3" cellspacing="0" border="1">
<tr>
<th><bean:message key="admin.reference.code"/></th>
<th><bean:message key="admin.reference.description"/></th></tr>
<tr><td><ns:field name="reference_AUTO" value="AUTO" type="text"/></td>
<td><bean:message key="admin.reference.auto"/></td></tr>
<tr><td><ns:field name="reference_HOMEOWNERS" value="HOMEOWNERS" type="text"/></td>
<td><bean:message key="admin.reference.homeowners"/></td></tr>
<tr><td><ns:field name="reference_COMMERCIAL" value="COMMERCIAL_PROPERTY" type="text"/></td>
<td><bean:message key="admin.reference.commercial"/></td></tr>
<tr><td><ns:field name="reference_LIABILITY" value="GENERAL_LIABILITY" type="text"/></td>
<td><bean:message key="admin.reference.liability"/></td></tr>
</table>
<p><bean:message key="admin.reference.note"/></p>
